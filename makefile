CORE = Joueur.cpp Jeu.cpp Bot.cpp Carte.cpp VarianteTourne.cpp VarianteDoublon.cpp VarianteEchange.cpp VarianteSuite.cpp VarianteCumul.cpp SalleAttente.cpp Menu.cpp# Pacman.cpp core/Terrain.cpp core/Jeu.cpp core/Fantome.cpp
